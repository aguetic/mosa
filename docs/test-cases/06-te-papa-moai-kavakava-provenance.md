...
3. entry into or presence in the Oldman Collection;
4. transfer described as a gift from the New Zealand Government in 1992;
5. present custody by Te Papa.

## Required distinctions

- The 1825 collection event is hypothetical, not established.
- The source's statement that the hypothesis seems unlikely must qualify or contradict the hypothesis rather than silently delete it.
...
- Can collection, arrival, collection membership, transfer, and current custody remain separate?
