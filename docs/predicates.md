...
| --------------------- | ------- | -------------------------------------------------------------------------------------------- |
| `refers_to`           | Entity  | A source or record refers to an entity                                                       |
| `created_by`          | Agent   | A source was created or published by an agent                                                |
...
| `physical_remains_of` | Agent   | Physical human remains are associated with the person whose remains they are                 |
